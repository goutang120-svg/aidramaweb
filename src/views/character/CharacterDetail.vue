...
.prompt-content { color: var(--text-secondary); font-size: 14px; line-height: 1.8; white-space: pre-wrap; padding: 16px; background: var(--bg-cream); border-radius: var(--radius-md); }
